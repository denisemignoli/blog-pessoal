...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				...
				.paths(PathSelectors.any()).build().apiInfo(dataApi()).useDefaultResponseMessages(false)
				.globalResponses(HttpMethod.GET, responseMessageForGET());
	}

	public static ApiInfo dataApi() {
	...
	private static Contact contact() {
		return new Contact("Denise Mignoli", "https://github.com/denisemignoli", "denisemignoli@gmail.com");
	}
